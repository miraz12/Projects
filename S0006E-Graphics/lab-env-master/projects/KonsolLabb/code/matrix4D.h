...
inline matrix4D setFromVector3(vector4D a, vector4D b, vector4D c)
{
    this->values2D[0][0] = a.Varray[0];
    this->values2D[0][1] = a.Varray[1];
    this->values2D[0][2] = a.Varray[2];
    this->values2D[0][3] = a.Varray[3];

    this->values2D[1][0] = b.Varray[0];
    this->values2D[1][1] = b.Varray[1];
    this->values2D[1][2] = b.Varray[2];
    this->values2D[1][3] = b.Varray[3];

    this->values2D[2][0] = c.Varray[0];
    this->values2D[2][1] = c.Varray[1];
    this->values2D[2][2] = c.Varray[2];
    this->values2D[2][3] = c.Varray[3];

...
void Model::draw(const glm::mat4 &nModel, const glm::vec3 &color)
{
	glm::vec3 apa = color;
	//Send Matrix to Shader
	glUniformMatrix4fv(ModelLocation, 1, GL_FALSE, &nModel[0][0]);
...
void Model::draw(const glm::mat4 &nModel, const glm::vec3 &color, bool line)
{
	glm::vec3 apa = color;
	//Send Matrix to Shader
	glUniformMatrix4fv(ModelLocation, 1, GL_FALSE, &nModel[0][0]);
